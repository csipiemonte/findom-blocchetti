...
public class SedeItemVO extends CommonalityVO {

	private static final long serialVersionUID = 1L;

	@Override
	public String toString() {
		return "SedeItemVO [idTipoSede=" + idTipoSede + 
					", idProvinciaSede=" + idProvinciaSede + 
					", idSede="+idSede +
					", descrTipoSede="+descrTipoSede +
					", descrProvinciaSede="+descrProvinciaSede +
					", siglaProvinciaSede="+siglaProvinciaSede +
					", idComuneSede="+idComuneSede +
					", descrComuneSede="+descrComuneSede +
					", idSedeAAEP="+idSedeAAEP +
					"]";
	}
	...
	public String getIdSedeAAEP() {
		return idSedeAAEP;
	}

	public void setIdSedeAAEP(String idSedeAAEP) {
		this.idSedeAAEP = idSedeAAEP;
	}
