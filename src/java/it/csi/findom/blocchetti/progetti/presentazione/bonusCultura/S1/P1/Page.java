 ...
 ******************************************************************************/
package it.csi.findom.blocchetti.progetti.presentazione.bonusCultura.S1.P1;

import it.csi.findom.blocchetti.blocchetti.operatorePresentatoreSemplificato.OperatorePresentatoreSemplificato;
...
import it.csi.findom.blocchetti.blocchetti.domandaNG.DomandaNG;
...
public class Page extends FinSectionPage { // refactoring
	...
	public Class[] getCommonalities() {
		return new Class[] { DomandaNG.class, UrlPagRegoleCompilazione.class, OperatorePresentatoreSemplificato.class};
	}
