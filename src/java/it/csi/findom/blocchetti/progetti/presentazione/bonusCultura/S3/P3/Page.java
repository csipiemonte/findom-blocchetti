 ...
 ******************************************************************************/
package it.csi.findom.blocchetti.progetti.presentazione.bonusCultura.S3.P3;
...
import it.csi.findom.blocchetti.blocchetti.gestioneDocumentiNG.GestioneDocumentiNG;
...
public class Page extends FinSectionPage { // refactoring
	...
	public Class[] getCommonalities() {
		return new Class[] {AccessoForbidden.class, UrlPagRegoleCompilazione.class, GestioneDocumentiNG.class };
	}
