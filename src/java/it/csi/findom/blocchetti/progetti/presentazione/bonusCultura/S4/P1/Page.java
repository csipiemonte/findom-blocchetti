...
import it.csi.findom.blocchetti.blocchetti.caratteristicheprogettoNG.CaratteristicheProgettoNG;
import it.csi.findom.blocchetti.blocchetti.urlPagRegoleCompilazione.UrlPagRegoleCompilazione;
import it.csi.findom.blocchetti.progetti.presentazione.bonusCultura.S4.Section;
...
public class Page extends FinSectionPage { // refactoring
	...
	protected void customInitializeData() {
		// valorizzare eventuali variabili di classe specifiche della sezione ( esempio imInAziendale)
	}
	...
	public Class[] getCommonalities() {
		return new Class[] {AccessoForbidden.class, UrlPagRegoleCompilazione.class, CaratteristicheProgettoNG.class};
	}
