...
import it.csi.findom.blocchetti.blocchetti.tipologiaAiutoNG.TipologiaAiutoNG;
...
public class Page extends FinSectionPage { // refactoring
	...
	public Class[] getCommonalities() {
		return new Class[] {AccessoForbidden.class, UrlPagRegoleCompilazione.class, TipologiaAiutoNG.class };
	}
