 ...
 ******************************************************************************/
package it.csi.findom.blocchetti.util;
  ...
  public static Vector parseKeywords(String keywordString) {
    if (keywordString != null) {
      ...
      try {
        ...
        return keywords;
			...
			System.out.println("[ERROR] StringUtils: Error in parseKeywords: "+ e.getMessage());
      }
    }
    return null;
  }
	...
	public static int getGiorniPeriodo(String dataInizioPeriodo, String dataFinePeriodo) {
		...
		try {
			...
			System.out.println("[ERROR] StringUtils: Error in getGiorniPeriodo: "+ e.getMessage());
		}
		return days;
	}
